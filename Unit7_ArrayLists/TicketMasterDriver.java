...
public class TicketMasterDriver
{
     ...
     * calls sort functions (by city, performer, cost) & performs them as the user desires
    ...
    /**
     *
     * @param input takes in a scanner parameter to get user's input repeatedly in a while loop, and
     *              ensures that the input is valid so other programs run
